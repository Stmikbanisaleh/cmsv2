...
$rows = $this->model_utama->view_where($table, array('judul_seo' => $url))->result_array();
foreach ($rows as $row) {
    ?>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="grid">
                            <div class="grid12">
                                <p class="date"><?php echo date("d F Y", strtotime($row['created_at'])); ?></p>
