                    ...
                    <article>
                        <ul>
                            ...
                            foreach ($data->result() as $row) {
                                ?>
                                <li>
                                    <a href="<?php echo base_url(); ?>index.php/home/<?php echo $function . "/" . $row->judul_seo; ?>">
                                        <?php
                                        if ($row->gambar != '') {
                                            echo "<img src='" . base_url() . $url . $row->gambar."' />";
                                        } else {
                                    ...
                                    <div>
                                        <h3><a href="<?php echo base_url(); ?>index.php/home/<?php echo $function . "/" . $row->judul_seo; ?>"><?php echo $row->judul_e; ?></a></h3>
                                        <p class="date"><?php echo date("d F Y", strtotime($row->tanggal)); ?></p>
                                        <p>
                                            <?php
                                            if ($table == 'berita') {
                                                echo character_limiter($row->isi_berita_e, 250);
                                            } elseif ($table == 'artikel') {
                                                echo character_limiter($row->isi_artikel_e, 250);
                                            }
                                            ?>
                                        </p>
                                        <a href="<?php echo base_url(); ?>index.php/home/<?php echo $function . "/" . $row->judul_seo; ?>" >Read more &rsaquo;&rsaquo;</a>
    <!--                                    <p class="tags">Tag</p>-->
                                    </div>
                                </li>
                                <?php
