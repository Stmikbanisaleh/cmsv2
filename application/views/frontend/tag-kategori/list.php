                        ...
                        <ul>
                            ...
                            foreach ($data->result() as $row) {
                                ...
                                <li>
                                    ...
                                    <div>
                                        <h3><a href="<?php echo base_url(); ?>index.php/home/<?php echo $function . "/" . $row->judul_seo; ?>"><?php echo $row->judul; ?></a></h3>
                                        <p class="date"><?php echo date("d F Y", strtotime($row->tanggal)); ?></p>
                                        <p>
                                            <?php
                                            if ($table == 'berita') {
                                                echo character_limiter($row->isi_berita, 250);
                                            } elseif ($table == 'artikel') {
                                                echo character_limiter($row->isi_artikel, 250);
                                            }
                                            ?>
                                        </p>
