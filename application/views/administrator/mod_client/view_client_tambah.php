    ...
    echo "<div class='col-md-12'>
          ...
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th width='120px' scope='row'>Title</th>   <td><input type='text' class='form-control' name='a'></td></tr>
                    <tr><th width='120px' scope='row'>URL Client</th>   <td><input type='text' class='form-control' name='b'></td></tr>
