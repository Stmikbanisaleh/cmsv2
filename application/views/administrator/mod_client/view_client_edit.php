<?php 
    echo "<div class='col-md-12'>
          ...
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                  <input type='hidden' name='id' value='$rows[id_client]'>
                    <tr><th width='120px' scope='row'>Title</th>   <td><input type='text' class='form-control' name='a' value='$rows[title]'></td></tr>
                    <tr><th width='120px' scope='row'>URL Client</th>   <td><input type='text' class='form-control' name='b' value='$rows[url_client]'></td></tr>
