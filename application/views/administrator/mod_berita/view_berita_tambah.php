...
//                   echo "<tr><th scope='row'>Video Youtube</th>          <td><input type='text' class='form-control' name='d' placeholder='Contoh link: http://www.youtube.com/embed/xbuEmoRWQHU'></td></tr>";
            echo "<tr><th scope='row'>Kategori</th>               <td><select name='a' class='form-control' required>
                    ...
                    <tr><th scope='row'>Isi Berita Inggris</th>             <td><textarea id='editor2' class='form-control' name='hh' style='height:260px' required></textarea></td></tr>
                    <tr><th scope='row'>Gambar</th>                 <td><input type='file' class='form-control' name='k'></td></tr>
                    <tr>            <td><input type='hidden' class='form-control' name='i'></td></tr>
